package com.fanpeak.app.data.local
...
import com.fanpeak.app.BuildConfig
...
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "fantok_settings")
