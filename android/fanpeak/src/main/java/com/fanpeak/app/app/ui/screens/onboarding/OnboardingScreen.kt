package com.fanpeak.app.ui.screens.onboarding
        ...
        Column(
            ...
            Text(
                ...
                style = MaterialTheme.typography.displayMedium.copy(
                    ...
                    brush = Brush.linearGradient(listOf(PrimaryRed, SecondaryOrange))
                )
            )
            Text(
                text = "连接到你的媒体服务器",
            ...
            when {
                uiState.isLoading -> CircularProgressIndicator(color = PrimaryRed)
