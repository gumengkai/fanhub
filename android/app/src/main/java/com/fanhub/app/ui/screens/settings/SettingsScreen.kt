package com.fanhub.app.ui.screens.settings
        ...
        Column(modifier = Modifier.padding(horizontal = 16.dp)) {
            ...
            Row(
                ...
                uiState.testResult?.let { result ->
                    Text(
                        text = result,
                        color = if (uiState.testSuccess) PrimaryPink else ErrorRed,
...
private fun SettingSwitch(label: String, value: Boolean, onToggle: (Boolean) -> Unit) {
    Row(
        ...
        Switch(
            ...
            colors = SwitchDefaults.colors(checkedThumbColor = TextPrimary, checkedTrackColor = PrimaryPink)
        )
    }
}
