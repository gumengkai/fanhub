...
- 💗 **喜欢功能** - 红心标记，快速表达喜爱
- ⭐ **收藏功能** - 星星图标，保存到收藏夹
- 🤖 **Android 客户端** - FanHub 完整版 + FanTok 短视频版
...
FanHub 提供两个 Android 客户端版本：

### FanHub - 完整版
功能齐全的媒体中心应用，包含视频库、图片库、播放历史等完整功能。

### FanTok - 短视频版
专注于短视频播放的轻量级应用，类似抖音的沉浸式体验。
...
cd android/fantok
./gradlew :app:assembleRelease
# APK: app/build/outputs/apk/release/fantok-release.apk
```
...
技术栈：Kotlin + Jetpack Compose + Material3 + Retrofit + ExoPlayer
...
- 🐛 修复 Android 短视频页面删除按钮无响应问题
  - 根 Box 手势检测与按钮点击冲突修复
  - 手势检测移至视频区域，按钮可正常接收点击事件
  - 影响范围：FanHub / FanPeak / FanTok 三个应用
...
### 已修复
- ✅ Android 短视频页面删除按钮无响应 (2026-05-14)
